...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appInfos/{id}/secondaryCategory',
  operationId: 'appInfos_secondaryCategory_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_secondary_category_app_infos',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.appInfos.retrieveSecondaryCategory(id, body)),
  );
};
