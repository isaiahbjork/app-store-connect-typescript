...
export const tool: Tool = {
  name: 'update_relationships_game_center_groups_game_center_leaderboard_sets',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.gameCenterGroups.relationships.gameCenterLeaderboardSets
    .update(id, body)
    .asResponse();
