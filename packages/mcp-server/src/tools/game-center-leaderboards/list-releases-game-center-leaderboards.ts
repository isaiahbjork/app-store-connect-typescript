...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterLeaderboards/{id}/releases',
  operationId: 'gameCenterLeaderboards_releases_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_releases_game_center_leaderboards',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterLeaderboards.listReleases(id, body));
};
