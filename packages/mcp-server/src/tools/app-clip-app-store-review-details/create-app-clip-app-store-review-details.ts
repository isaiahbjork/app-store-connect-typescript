...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.appClipAppStoreReviewDetails.create(body)));
};
