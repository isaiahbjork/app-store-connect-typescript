...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appStoreVersions/{id}/customerReviews',
  operationId: 'appStoreVersions_customerReviews_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_customer_reviews_app_store_versions',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.appStoreVersions.retrieveCustomerReviews(id, body));
};
