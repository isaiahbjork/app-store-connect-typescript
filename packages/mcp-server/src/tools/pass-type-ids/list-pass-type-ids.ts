...
export const metadata: Metadata = {
  ...
  operationId: 'passTypeIds_getCollection',
};
  ...
  inputSchema: {
    ...
    properties: {
      ...
      sort: {
        ...
        items: {
          type: 'string',
          enum: ['name', '-name', 'identifier', '-identifier', 'id', '-id'],
        },
      },
      jq_filter: {
        type: 'string',
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.passTypeIDs.list(body)));
};
