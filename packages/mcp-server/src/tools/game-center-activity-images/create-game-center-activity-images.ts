...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/gameCenterActivityImages',
  operationId: 'gameCenterActivityImages_createInstance',
};

export const tool: Tool = {
  name: 'create_game_center_activity_images',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.gameCenterActivityImages.create(body)));
};
