...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/analyticsReports/{id}/relationships/instances',
  operationId: 'analyticsReports_instances_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_instances_analytics_reports_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.analyticsReports.relationships.listInstances(id, body)),
  );
};
