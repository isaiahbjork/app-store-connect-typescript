...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/subscriptionGroups/{id}/relationships/subscriptionGroupLocalizations',
  operationId: 'subscriptionGroups_subscriptionGroupLocalizations_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_localizations_subscription_groups_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.subscriptionGroups.relationships.listLocalizations(id, body)),
  );
};
