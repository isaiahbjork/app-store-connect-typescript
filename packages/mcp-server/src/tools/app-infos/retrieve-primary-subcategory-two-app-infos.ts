...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appInfos/{id}/primarySubcategoryTwo',
  operationId: 'appInfos_primarySubcategoryTwo_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_primary_subcategory_two_app_infos',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.appInfos.retrievePrimarySubcategoryTwo(id, body)),
  );
};
