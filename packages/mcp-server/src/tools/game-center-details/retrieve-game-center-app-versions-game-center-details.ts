...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterDetails/{id}/gameCenterAppVersions',
  operationId: 'gameCenterDetails_gameCenterAppVersions_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_game_center_app_versions_game_center_details',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterDetails.retrieveGameCenterAppVersions(id, body));
};
