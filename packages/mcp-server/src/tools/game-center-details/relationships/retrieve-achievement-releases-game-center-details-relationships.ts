...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterDetails/{id}/relationships/achievementReleases',
  operationId: 'gameCenterDetails_achievementReleases_getToManyRelationship',
};

export const tool: Tool = {
  name: 'retrieve_achievement_releases_game_center_details_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.gameCenterDetails.relationships.retrieveAchievementReleases(id, body),
    ),
  );
};
