...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterGroups/{id}/gameCenterLeaderboardSets',
  operationId: 'gameCenterGroups_gameCenterLeaderboardSets_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_game_center_leaderboard_sets_game_center_groups',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterGroups.listGameCenterLeaderboardSets(id, body));
};
