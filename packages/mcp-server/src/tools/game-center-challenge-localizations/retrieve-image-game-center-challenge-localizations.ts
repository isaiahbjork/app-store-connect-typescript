...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterChallengeLocalizations/{id}/image',
  operationId: 'gameCenterChallengeLocalizations_image_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_image_game_center_challenge_localizations',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.gameCenterChallengeLocalizations.retrieveImage(id, body)),
  );
};
