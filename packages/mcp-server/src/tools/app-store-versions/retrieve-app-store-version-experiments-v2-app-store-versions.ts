...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appStoreVersions/{id}/appStoreVersionExperimentsV2',
  operationId: 'appStoreVersions_appStoreVersionExperimentsV2_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_app_store_version_experiments_v2_app_store_versions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.appStoreVersions.retrieveAppStoreVersionExperimentsV2(id, body));
};
