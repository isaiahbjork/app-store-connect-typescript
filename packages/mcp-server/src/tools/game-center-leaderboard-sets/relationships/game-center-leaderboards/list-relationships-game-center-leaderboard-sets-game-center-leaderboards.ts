...
export const tool: Tool = {
  name: 'list_relationships_game_center_leaderboard_sets_game_center_leaderboards',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.gameCenterLeaderboardSets.relationships.gameCenterLeaderboards.list(id, body),
    ),
  );
};
