...
export const tool: Tool = {
  name: 'delete_game_center_leaderboard_set_member_localizations',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.gameCenterLeaderboardSetMemberLocalizations.delete(id).asResponse();
