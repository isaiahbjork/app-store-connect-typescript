...
export const tool: Tool = {
  name: 'create_relationships_game_center_leaderboard_sets_game_center_leaderboards',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  await client.gameCenterLeaderboardSets.relationships.gameCenterLeaderboards.create(id, body);
