...
export class Relationships extends APIResource {
  listLocalizations(
    ...
    return this._client.get(path`/v1/gameCenterActivityVersions/${id}/relationships/localizations`, {
      query,
      ...options,
    });
  }
  ...
  retrieveDefaultImage(
    ...
    return this._client.get(path`/v1/gameCenterActivityVersions/${id}/relationships/defaultImage`, options);
  }
}
