...
describe('resource appClipAppStoreReviewDetails', () => {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.appClipAppStoreReviewDetails.create({
      data: {
        ...
        type: 'appClipAppStoreReviewDetails',
        attributes: { invocationUrls: ['https://example.com'] },
      },
    });
  });
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.appClipAppStoreReviewDetails.retrieve(
        'id',
        { 'fields[appClipAppStoreReviewDetails]': ['invocationUrls'], include: ['appClipDefaultExperience'] },
