...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterEnabledVersions/{id}/compatibleVersions',
  operationId: 'gameCenterEnabledVersions_compatibleVersions_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_compatible_versions_game_center_enabled_versions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterEnabledVersions.listCompatibleVersions(id, body));
};
