...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterMatchmakingRules/{id}/metrics/matchmakingRuleErrors',
  operationId: 'gameCenterMatchmakingRules_matchmakingRuleErrors_getMetrics',
};

export const tool: Tool = {
  name: 'retrieve_rule_errors_game_center_matchmaking_rules_metrics',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterMatchmakingRules.metrics.retrieveRuleErrors(id, body));
};
