...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appInfos/{id}/primarySubcategoryOne',
  operationId: 'appInfos_primarySubcategoryOne_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_primary_subcategory_one_app_infos',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.appInfos.retrievePrimarySubcategoryOne(id, body)),
  );
};
