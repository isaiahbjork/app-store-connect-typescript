...
export const tool: Tool = {
  name: 'retrieve_game_center_leaderboard_sets_relationships_game_center_details_game_center_leaderboard_sets',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.gameCenterDetails.relationships.gameCenterLeaderboardSets.retrieveGameCenterLeaderboardSets(
      id,
      body,
    ),
  );
