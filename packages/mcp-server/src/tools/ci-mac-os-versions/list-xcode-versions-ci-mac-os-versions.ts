...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/ciMacOsVersions/{id}/xcodeVersions',
  operationId: 'ciMacOsVersions_xcodeVersions_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_xcode_versions_ci_mac_os_versions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.ciMacOsVersions.listXcodeVersions(id, body)),
  );
};
