...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterDetails/{id}/gameCenterChallenges',
  operationId: 'gameCenterDetails_gameCenterChallenges_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_game_center_challenges_game_center_details',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterDetails.retrieveGameCenterChallenges(id, body));
};
