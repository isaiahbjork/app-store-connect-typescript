...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appPreviewSets',
  operationId: 'appStoreVersionExperimentTreatmentLocalizations_appPreviewSets_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_app_preview_sets_app_store_version_experiment_treatment_localizations',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.appStoreVersionExperimentTreatmentLocalizations.listAppPreviewSets(id, body),
  );
};
