...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/appStoreVersionExperimentTreatmentLocalizations',
  operationId: 'appStoreVersionExperimentTreatmentLocalizations_createInstance',
};

export const tool: Tool = {
  name: 'create_app_store_version_experiment_treatment_localizations',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.appStoreVersionExperimentTreatmentLocalizations.create(body));
};
