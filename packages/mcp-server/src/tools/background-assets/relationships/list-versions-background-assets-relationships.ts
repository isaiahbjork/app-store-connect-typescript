...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/backgroundAssets/{id}/relationships/versions',
  operationId: 'backgroundAssets_versions_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_versions_background_assets_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.backgroundAssets.relationships.listVersions(id, body)),
  );
};
