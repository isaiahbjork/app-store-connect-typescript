...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/webhooks/{id}/relationships/deliveries',
  operationId: 'webhooks_deliveries_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_deliveries_webhooks_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.webhooks.relationships.listDeliveries(id, body)),
  );
};
