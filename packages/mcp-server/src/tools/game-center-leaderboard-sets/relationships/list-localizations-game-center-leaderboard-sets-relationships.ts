...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterLeaderboardSets/{id}/relationships/localizations',
  operationId: 'gameCenterLeaderboardSets_localizations_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_localizations_game_center_leaderboard_sets_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(args, await client.gameCenterLeaderboardSets.relationships.listLocalizations(id, body)),
  );
};
