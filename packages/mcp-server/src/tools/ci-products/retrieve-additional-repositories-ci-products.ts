...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/ciProducts/{id}/additionalRepositories',
  operationId: 'ciProducts_additionalRepositories_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_additional_repositories_ci_products',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.ciProducts.retrieveAdditionalRepositories(id, body)),
  );
};
