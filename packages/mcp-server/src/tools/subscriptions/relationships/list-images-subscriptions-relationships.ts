...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/subscriptions/{id}/relationships/images',
  operationId: 'subscriptions_images_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_images_subscriptions_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.subscriptions.relationships.listImages(id, body)),
  );
};
