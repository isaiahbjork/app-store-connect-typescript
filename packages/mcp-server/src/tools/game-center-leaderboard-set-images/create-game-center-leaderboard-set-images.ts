...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/gameCenterLeaderboardSetImages',
  operationId: 'gameCenterLeaderboardSetImages_createInstance',
};

export const tool: Tool = {
  name: 'create_game_center_leaderboard_set_images',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.gameCenterLeaderboardSetImages.create(body)),
  );
};
