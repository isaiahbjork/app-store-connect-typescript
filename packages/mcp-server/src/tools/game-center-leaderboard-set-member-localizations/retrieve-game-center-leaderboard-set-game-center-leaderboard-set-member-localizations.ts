...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterLeaderboardSetMemberLocalizations/{id}/gameCenterLeaderboardSet',
  operationId: 'gameCenterLeaderboardSetMemberLocalizations_gameCenterLeaderboardSet_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_game_center_leaderboard_set_game_center_leaderboard_set_member_localizations',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.gameCenterLeaderboardSetMemberLocalizations.retrieveGameCenterLeaderboardSet(id, body),
  );
};
