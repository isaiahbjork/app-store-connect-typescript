...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v2/inAppPurchases/{id}/promotedPurchase',
  operationId: 'inAppPurchasesV2_promotedPurchase_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_promoted_purchase_in_app_purchases',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.inAppPurchases.retrievePromotedPurchase(id, body));
};
