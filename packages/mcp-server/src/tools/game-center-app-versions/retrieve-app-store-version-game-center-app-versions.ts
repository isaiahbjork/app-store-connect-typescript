...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterAppVersions/{id}/appStoreVersion',
  operationId: 'gameCenterAppVersions_appStoreVersion_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_app_store_version_game_center_app_versions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterAppVersions.retrieveAppStoreVersion(id, body));
};
