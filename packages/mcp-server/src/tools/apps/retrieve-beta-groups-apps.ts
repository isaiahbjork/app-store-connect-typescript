...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/apps/{id}/betaGroups',
  operationId: 'apps_betaGroups_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_beta_groups_apps',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.apps.retrieveBetaGroups(id, body)));
};
