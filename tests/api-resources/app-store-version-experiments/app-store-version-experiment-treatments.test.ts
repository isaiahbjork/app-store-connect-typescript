...
describe('resource appStoreVersionExperimentTreatments', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = client.appStoreVersionExperiments.appStoreVersionExperimentTreatments.list('id');
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.appStoreVersionExperiments.appStoreVersionExperimentTreatments.list(
        'id',
        {
