...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterLeaderboardSets/{id}/gameCenterLeaderboards',
  operationId: 'gameCenterLeaderboardSets_gameCenterLeaderboards_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_game_center_leaderboards_game_center_leaderboard_sets',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterLeaderboardSets.listGameCenterLeaderboards(id, body));
};
