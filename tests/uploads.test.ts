import fs from 'fs';
import type { ResponseLike } from 'app-store-connect-api/internal/to-file';
import { toFile } from 'app-store-connect-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('app-store-connect-api/core/uploads');
    await expect(
