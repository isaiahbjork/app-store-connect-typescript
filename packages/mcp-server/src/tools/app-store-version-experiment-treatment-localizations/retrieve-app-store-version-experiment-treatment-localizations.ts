...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appStoreVersionExperimentTreatmentLocalizations/{id}',
  operationId: 'appStoreVersionExperimentTreatmentLocalizations_getInstance',
};

export const tool: Tool = {
  name: 'retrieve_app_store_version_experiment_treatment_localizations',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.appStoreVersionExperimentTreatmentLocalizations.retrieve(id, body));
};
