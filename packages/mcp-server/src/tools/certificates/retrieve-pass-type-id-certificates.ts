...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/certificates/{id}/passTypeId',
  operationId: 'certificates_passTypeId_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_pass_type_id_certificates',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.certificates.retrievePassTypeID(id, body)));
};
