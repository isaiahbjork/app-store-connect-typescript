...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/subscriptions/{id}/subscriptionLocalizations',
  operationId: 'subscriptions_subscriptionLocalizations_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_subscription_localizations_subscriptions',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.subscriptions.listSubscriptionLocalizations(id, body));
};
