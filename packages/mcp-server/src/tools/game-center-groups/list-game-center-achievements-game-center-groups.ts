...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterGroups/{id}/gameCenterAchievements',
  operationId: 'gameCenterGroups_gameCenterAchievements_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_game_center_achievements_game_center_groups',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterGroups.listGameCenterAchievements(id, body));
};
