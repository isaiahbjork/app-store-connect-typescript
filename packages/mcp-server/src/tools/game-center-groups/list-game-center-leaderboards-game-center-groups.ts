...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterGroups/{id}/gameCenterLeaderboards',
  operationId: 'gameCenterGroups_gameCenterLeaderboards_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_game_center_leaderboards_game_center_groups',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterGroups.listGameCenterLeaderboards(id, body));
};
