...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/subscriptions/{id}/pricePoints',
  operationId: 'subscriptions_pricePoints_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_price_points_subscriptions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.subscriptions.listPricePoints(id, body)));
};
