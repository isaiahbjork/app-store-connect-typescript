...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/winBackOffers/{id}/prices',
  operationId: 'winBackOffers_prices_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_prices_win_back_offers',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.winBackOffers.listPrices(id, body)));
};
