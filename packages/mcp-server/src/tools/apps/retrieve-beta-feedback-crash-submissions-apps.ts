...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/apps/{id}/betaFeedbackCrashSubmissions',
  operationId: 'apps_betaFeedbackCrashSubmissions_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_beta_feedback_crash_submissions_apps',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.apps.retrieveBetaFeedbackCrashSubmissions(id, body));
};
