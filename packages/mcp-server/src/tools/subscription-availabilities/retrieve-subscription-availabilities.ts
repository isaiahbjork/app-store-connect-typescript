...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/subscriptionAvailabilities/{id}',
  operationId: 'subscriptionAvailabilities_getInstance',
};

export const tool: Tool = {
  name: 'retrieve_subscription_availabilities',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.subscriptionAvailabilities.retrieve(id, body));
};
