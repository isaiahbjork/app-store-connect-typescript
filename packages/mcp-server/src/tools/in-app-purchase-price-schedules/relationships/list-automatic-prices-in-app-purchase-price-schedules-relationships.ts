...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/inAppPurchasePriceSchedules/{id}/relationships/automaticPrices',
  operationId: 'inAppPurchasePriceSchedules_automaticPrices_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_automatic_prices_in_app_purchase_price_schedules_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.inAppPurchasePriceSchedules.relationships.listAutomaticPrices(id, body),
    ),
  );
};
