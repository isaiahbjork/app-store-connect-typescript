...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appClipDefaultExperiences/{id}/releaseWithAppStoreVersion',
  operationId: 'appClipDefaultExperiences_releaseWithAppStoreVersion_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_release_with_app_store_version_app_clip_default_experiences',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.appClipDefaultExperiences.retrieveReleaseWithAppStoreVersion(id, body),
  );
};
