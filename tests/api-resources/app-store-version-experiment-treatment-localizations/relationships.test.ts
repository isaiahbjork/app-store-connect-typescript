...
describe('resource relationships', () => {
  ...
  test.skip('listAppPreviewSets: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.appStoreVersionExperimentTreatmentLocalizations.relationships.listAppPreviewSets(
        'id',
        { limit: 200 },
  ...
  test.skip('listAppScreenshotSets: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.appStoreVersionExperimentTreatmentLocalizations.relationships.listAppScreenshotSets(
        'id',
        { limit: 200 },
        { path: '/_stainless_unknown_path' },
      ),
