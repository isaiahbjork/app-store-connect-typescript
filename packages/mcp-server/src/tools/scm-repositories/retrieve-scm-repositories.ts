...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/scmRepositories/{id}',
  operationId: 'scmRepositories_getInstance',
};

export const tool: Tool = {
  name: 'retrieve_scm_repositories',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.scmRepositories.retrieve(id, body)));
};
