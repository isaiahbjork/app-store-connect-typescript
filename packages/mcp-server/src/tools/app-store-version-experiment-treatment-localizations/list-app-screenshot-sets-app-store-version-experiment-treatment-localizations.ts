...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appScreenshotSets',
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await client.appStoreVersionExperimentTreatmentLocalizations.listAppScreenshotSets(id, body),
  );
};
