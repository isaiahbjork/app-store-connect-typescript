...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterActivityVersions/{id}/defaultImage',
  operationId: 'gameCenterActivityVersions_defaultImage_getToOneRelated',
};

export const tool: Tool = {
  name: 'retrieve_default_image_game_center_activity_versions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.gameCenterActivityVersions.retrieveDefaultImage(id, body)),
  );
};
