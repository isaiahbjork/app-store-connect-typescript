...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/inAppPurchasePriceSchedules/{id}/relationships/manualPrices',
  operationId: 'inAppPurchasePriceSchedules_manualPrices_getToManyRelationship',
};

export const tool: Tool = {
  name: 'list_manual_prices_in_app_purchase_price_schedules_relationships',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      jq_filter,
      await client.inAppPurchasePriceSchedules.relationships.listManualPrices(id, body),
    ),
  );
};
