...
export class Relationships extends APIResource {
  listAutomaticPrices(
    ...
    return this._client.get(path`/v1/inAppPurchasePriceSchedules/${id}/relationships/automaticPrices`, {
      query,
      ...options,
    });
  }
  ...
  listManualPrices(
    ...
    return this._client.get(path`/v1/inAppPurchasePriceSchedules/${id}/relationships/manualPrices`, {
      query,
      ...options,
    });
  }
  ...
  retrieveBaseTerritory(
    ...
    return this._client.get(path`/v1/inAppPurchasePriceSchedules/${id}/relationships/baseTerritory`, options);
  }
}
