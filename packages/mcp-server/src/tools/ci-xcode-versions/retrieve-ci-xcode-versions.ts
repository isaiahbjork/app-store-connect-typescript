...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/ciXcodeVersions/{id}',
  operationId: 'ciXcodeVersions_getInstance',
};

export const tool: Tool = {
  name: 'retrieve_ci_xcode_versions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.ciXcodeVersions.retrieve(id, body)));
};
