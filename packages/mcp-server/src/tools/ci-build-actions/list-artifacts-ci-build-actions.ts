...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/ciBuildActions/{id}/artifacts',
  operationId: 'ciBuildActions_artifacts_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_artifacts_ci_build_actions',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.ciBuildActions.listArtifacts(id, body)));
};
