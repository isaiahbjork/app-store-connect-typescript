...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/gameCenterDetails/{id}/gameCenterActivities',
  operationId: 'gameCenterDetails_gameCenterActivities_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_game_center_activities_game_center_details',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.gameCenterDetails.retrieveGameCenterActivities(id, body));
};
