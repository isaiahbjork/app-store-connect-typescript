...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/buildBundles/{id}/buildBundleFileSizes',
  operationId: 'buildBundles_buildBundleFileSizes_getToManyRelated',
};

export const tool: Tool = {
  name: 'retrieve_build_bundle_file_sizes_build_bundles',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      'fields[buildBundleFileSizes]': {
        ...
        items: {
          type: 'string',
          enum: ['deviceModel', 'osVersion', 'downloadBytes', 'installBytes'],
        },
      },
      limit: {
        type: 'integer',
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.buildBundles.retrieveBuildBundleFileSizes(id, body)),
  );
};
