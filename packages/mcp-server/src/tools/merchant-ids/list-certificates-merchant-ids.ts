...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v1/merchantIds/{id}/certificates',
  operationId: 'merchantIds_certificates_getToManyRelated',
};

export const tool: Tool = {
  name: 'list_certificates_merchant_ids',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.merchantIDs.listCertificates(id, body)));
};
