...
import { ClientOptions } from 'app-store-connect-api';
...
export { ClientOptions } from 'app-store-connect-api';
...
export function initMcpServer(params: {
  ...
  const client = new AppStoreConnectAPI(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new AppStoreConnectAPI({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
