...
export const tool: Tool = {
  name: 'retrieve_game_center_leaderboards_relationships_game_center_details_game_center_leaderboards',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.gameCenterDetails.relationships.gameCenterLeaderboards.retrieveGameCenterLeaderboards(
        id,
        body,
      ),
    ),
