...
export const tool: Tool = {
  name: 'retrieve_promoted_purchases_relationships_apps_promoted_purchases',
  description:
...
export const handler = async (client: AppStoreConnectAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.apps.relationships.promotedPurchases.retrievePromotedPurchases(id, body),
    ),
  );
};
